...
{
    .pump = (void*)_QowSesPump,
    .getClipContent = (void*)CopyOutClipboard,
    .setClipContent = (void*)CopyIntoClipboard,
    .hasClipContent = (void*)HasClipboardContent,
    .getCurs = (void*)getMousePosition,
    .immerge = (void*)immergeWindow,
    .promote = (void*)_QowPromoteWindow,
    .grabCursor = (void*)grabCursor
};
